...
import { getPageBySlug, getWorkspaces } from '@/lib/store';
...
export default function PublicPageViewer({ params }: Props) {
  ...
  const page = getPageBySlug(workspaceSlug, slug);
  const workspaces = getWorkspaces();
  const workspace = workspaces.find((w) => w.slug === workspaceSlug);

  // 404 state: page not found or not public
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-8">
              This page doesn&apos;t exist or isn&apos;t publicly available.
            </p>
    ...
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-10">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 leading-tight mb-3">
            {page.title}
          </h1>
